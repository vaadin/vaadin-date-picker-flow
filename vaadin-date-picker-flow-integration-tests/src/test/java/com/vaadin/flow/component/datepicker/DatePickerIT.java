...
public class DatePickerIT extends ComponentDemoTest {
    ...
    public void selectDatesBeforeYear1000SimulateUserInput() {
        ...
        setInputValueAndAssert(localePicker, "3/7/900",
                LocalDate.of(900, Month.MARCH, 7));

        setInputValueAndAssert(localePicker, "3/6/900", "3/6/900",
                LocalDate.of(900, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "3/5/87",
                LocalDate.of(87, Month.MARCH, 5));
        setInputValueAndAssert(localePicker, "3/6/87", "3/6/87",
                LocalDate.of(87, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "3/7/20", "3/7/20",
                LocalDate.of(20, Month.MARCH, 7));
        setInputValueAndAssert(localePicker, "3/8/20",
                LocalDate.of(20, Month.MARCH, 8));

        $("button").id("Locale-UK").click();
        Assert.assertEquals("08/03/20", localePicker.getInputValue());

        setInputValueAndAssert(localePicker, "7/3/900", "07/03/900",
                LocalDate.of(900, Month.MARCH, 7));

        setInputValueAndAssert(localePicker, "6/3/900", "06/03/900",
                LocalDate.of(900, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "5/3/87", "05/03/87",
                LocalDate.of(87, Month.MARCH, 5));
        setInputValueAndAssert(localePicker, "6/3/87", "06/03/87",
                LocalDate.of(87, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "7/3/20", "07/03/20",
                LocalDate.of(20, Month.MARCH, 7));
        setInputValueAndAssert(localePicker, "8/3/20", "08/03/20",
                LocalDate.of(20, Month.MARCH, 8));

        $("button").id("Locale-CHINA").click();
        Assert.assertEquals("20/3/8", localePicker.getInputValue());

        setInputValueAndAssert(localePicker, "900/3/7",
                LocalDate.of(900, Month.MARCH, 7));

        setInputValueAndAssert(localePicker, "900/3/6", "900/3/6",
                LocalDate.of(900, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "87/3/5",
                LocalDate.of(87, Month.MARCH, 5));
        setInputValueAndAssert(localePicker, "87/3/6", "87/3/6",
                LocalDate.of(87, Month.MARCH, 6));
        setInputValueAndAssert(localePicker, "20/3/7", "20/3/7",
                LocalDate.of(20, Month.MARCH, 7));
        setInputValueAndAssert(localePicker, "20/3/8",
                LocalDate.of(20, Month.MARCH, 8));
